...
Sign up at [answerr.ai](http://answerr.ai) and grab your API key from the dashboard. You'll need this for all requests.

## 2. Make Your First Request

```javascript
curl -X POST https://connect.answerr.ai/v1/chat/completions \
...
```javascript
const response = await fetch('https://connect.answerr.ai/v1/chat/completions', {
  method: 'POST',
  headers: {
